...
/**
 * Helper class for adding {@link twigkit.markup.html.HtmlCapabilityImpl} when using {@link SimpleTagSupport}.
 *
 * @author mr.olafsson
 */
public abstract class HtmlSimpleTagSupport extends SimpleTagSupport implements HtmlCapability {
    ...
    public HtmlSimpleTagSupport(Writer writer, Class context) {
        this.htmlCapability = new HtmlCapabilityImpl(writer, context);
    }
